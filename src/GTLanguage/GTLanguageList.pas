...
uses gnugettext, Windows, SysUtils, Forms, GTLanguagesEx, common{, dzDFASDefine};
...
begin
  ...
  begin
    ...
    begin
      if installedLanguages[lang] = 'en' then
      begin
        LANGUAGE_ENGLISH := lang;
      end else if installedLanguages[lang] = 'ko' then
      begin
        LANGUAGE_KOREA := lang;
      end else if installedLanguages[lang] = 'ja' then
      begin
  ...
  begin
    ...
    add(dgettext('languages', 'Japanese'),   'ja');
  end;
end;
{$WARNINGS OFF}
